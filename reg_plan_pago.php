...
if ($fecha_plan_pago=="" OR $mostoplanpago=="" OR $tipo_cambiopalpago=="" OR $cantmeses=="" OR $interespa=="") {
	...
	$datos=mysql_query("INSERT INTO plan_pagos(fecha,nomto,tipo_cambio,cantidad_meses,interes,idventas) 
		     VALUES('$fecha_plan_pago','$mostoplanpago','$tipo_cambiopalpago','$cantmeses','$interespa','$idventa')");
	if ($datos) {

$cnue=mysql_query("SELECT fecha,nomto,cantidad_meses,interes,idplan_pagos FROM plan_pagos WHERE idventas='$idventa' ");
