   ...
   <script type="text/javascript">
    ...
    $(document).ready(function (){
        $("#reg_des").on("click", function (){//ID DEL BOTON 
            $.ajax({ 
                url: 'reg_transaccion_bancos.php', //DONDE VA HA IR
...
<div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">TRANSACCION DIARIA <b>BANCO/S</b></h5>
...
<?php 
$hsh=mysql_query("SELECT * FROM entidad_bancaria");
